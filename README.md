...
## 使用maven从jar文件安装
```
mvn install:install-file -DgroupId=com.daimakuai -DartifactId=fastdfs-client-java -Dversion=${version} -Dpackaging=jar -Dfile=fastdfs-client-java-${version}.jar
```
...
## .conf 配置文件、所在目录、加载优先顺序
    ...
    C:\Users\Yangtao\config\fdfs_client.conf
...
## .properties 配置文件、所在目录、加载优先顺序
    ...
    C:\Users\Yangtao\config\fastdfs-client.properties
...
## 加载配置示例
    ...
    ClientGlobal.init("C:\\Users\\Yangtao\\config\\fdfs_client.conf");

    加载 properties 格式文件配置：
    ClientGlobal.initByProperties("fastdfs-client.properties");
    ClientGlobal.initByProperties("config/fastdfs-client.properties");
    ClientGlobal.initByProperties("/opt/fastdfs-client.properties");
    ClientGlobal.initByProperties("C:\\Users\\Yangtao\\config\\fastdfs-client.properties");
